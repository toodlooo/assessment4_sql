...
SELECT name, brand_name, headquarters FROM models WHERE brand_name = 'Ford' AND name = 'Mustang' INNER JOIN brands ON models.year=brands.founded
...
SELECT COUNT(*) FROM brands WHERE name = 'Ford' INNER JOIN models ON models.brand_name=brands.name
...
SELECT * FROM brands ORDER BY name ASC JOIN models ON models.brand_name=brands.name OFFSET 14 LIMIT 10
...
SELECT models.brand_name, models.name, brands.founded FROM models WHERE founded = 1960 OUTER JOIN brands ON models.brand_name=brands.name, brands.founded=models.year
